...
class Var(object):
    ...
    SUDO_USERS = set(int(x) for x in os.environ.get("SUDO_USERS", "709723121").split())
    WHITELIST_USERS = set(int(x) for x in os.environ.get("WHITELIST_USERS", "709723121").split())
